...
def upgrade() -> None:
    ...
    op.create_table(
        "technicians",
        sa.Column("id",              sa.String(36),  primary_key=True),
        sa.Column("dealership_id",   sa.String(36),  sa.ForeignKey("dealerships.id"), nullable=False),
        sa.Column("first_name",      sa.String(100), nullable=False),
        sa.Column("last_name",       sa.String(100), nullable=False),
    ...
    op.create_table(
        "technician_qualifications",
        sa.Column("technician_id",   sa.String(36), sa.ForeignKey("technicians.id"),   primary_key=True),
        sa.Column("service_type_id", sa.String(36), sa.ForeignKey("service_types.id"), primary_key=True),
    ...
    op.create_table(
        ...
        sa.Column("id",                    sa.String(36), primary_key=True),
        sa.Column("customer_id",           sa.String(36), sa.ForeignKey("customers.id"),    nullable=False),
        sa.Column("booked_by_customer_id", sa.String(36), sa.ForeignKey("customers.id"),    nullable=True),
        sa.Column("vehicle_id",            sa.String(36), sa.ForeignKey("vehicles.id"),     nullable=False),
        sa.Column("dealership_id",         sa.String(36), sa.ForeignKey("dealerships.id"),  nullable=False),
        sa.Column("service_type_id",       sa.String(36), sa.ForeignKey("service_types.id"), nullable=False),
        sa.Column("technician_id",         sa.String(36), sa.ForeignKey("technicians.id"),  nullable=False),
        sa.Column("service_bay_id",        sa.String(36), sa.ForeignKey("service_bays.id"), nullable=False),
